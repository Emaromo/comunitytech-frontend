...
const Hero = () => {
  ...
  // === Acción al hacer clic en WhatsApp ===
  ...
  return (
     ...
     * 🔥 FIX IMPORTANTE 🔥
     * ---------------------------------------
     * Acá está la corrección que necesitabas:
     * pt-24 se veía excelente en desktop,
     * pero en mobile generaba un espacio enorme.
     * 
     * Ahora: 
     * - pt-14 = 56px (igual que el Header móvil)
     * - md:pt-16 = 64px (igual que el Header desktop)
     * 
     * Esto alinea PERFECTO el Hero debajo del Header
     * en todas las resoluciones.
     */
    <section className="pt-14 md:pt-16 pb-16 gradient-bg tech-pattern relative overflow-hidden">

      {/* === Icono flotante izquierdo === */}
      <div
        className="absolute top-24 left-10 floating-animation"
      ...
      <div
        className="absolute top-24 right-10 floating-animation"
        style={{ animationDelay: '2s' }}
      >
        <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center">
